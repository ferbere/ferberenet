...
if(isset($_GET['ruta'])){
	...
	if(empty($ruta)){
		$ruta='bus_privilegios.php';
	}
?>
<h1>Edita privilegios</h1>
<div align="center">
...
<?php
			...
			$sql = "SELECT @numero:=@numero+1 AS orden,nombre,id FROM usuario_privilegios WHERE id > 1 ";
			$celdas=array(0=>'id',1=>'nombre');
			$pez=" and nombre like '%" . $criterio . "%'";
			$set='if_privilegios_a.php';
			$ruta='bus_privilegios.php';
