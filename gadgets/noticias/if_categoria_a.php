...
if(($_SESSION["privilegioss"]=="ferbere")||($_SESSION["privilegioss"]=="admin")){
	...
	if(empty($capturado)){
		$sql=mysql_query("SELECT id,nombre,imagen FROM noticias_categoria WHERE id = '$rubro' ",$link);
...
?>
		<form method="post" action="gadgets/noticias/ip_categoria_a.php" enctype="multipart/form-data">
		...
		<?php		}else{?>
				<?php echo $imagen; ?>
					<a href="gadgets/noticias/borra_imagen.php?borra=2&rubro=<?php echo $rubro; ?>">Borrar y cargar otra imagen</a>
		<?php } ?>			
			</fieldset>
