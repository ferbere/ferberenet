...
<?php
			...
			$sql = "SELECT @numero:=@numero+1 AS orden,imagen,id FROM descargar_index ";
			$celdas=array(0=>'id',1=>'imagen');
			$pez=" where imagen like '%" . $criterio . "%' or imagen like '%" . $criterio . "%'";
