...
if(($_SESSION["privilegioss"]=="ferbere")||($_SESSION["privilegioss"]=="admin")){
	...
	if(empty($capturado)){
		$sql=mysql_query("SELECT id,nombre,imagen FROM activismo_rango WHERE id = '$rubro' ",$link);
	...
	?>
		<div id="form-main">
			<form method="post" action="gadgets/activismo/ip_rango_a.php">
			<div id="maincontent-tit">
				Modificar rango<br><br>
			</div>
